...
export const WorkflowPanel: React.FC<WorkflowPanelProps> = ({
    ...
    return (
        <>
            ...
            {editingCoverFor && (
                <div className="fixed inset-0 bg-black/55 backdrop-blur-sm flex items-center justify-center z-50 motion-modal-overlay-in">
                    <div className={`border rounded-[var(--myml-radius-modal)] p-6 w-[500px] max-h-[500px] shadow-[var(--myml-shadow-panel)] flex flex-col motion-modal-dialog-in ${isDark ? 'bg-[var(--myml-surface-panel)] border-[var(--myml-border-default)]' : 'bg-white border-neutral-200'}`}>

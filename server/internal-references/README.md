...
INTERNAL_REFERENCE_IMAGE_MODEL_ID=custom-image-t8-gpt-image-2-edit
```
...
Hermes design tasks without matched hidden internal references use a runtime-only text-to-image fallback model, `custom-image-t8-nano-banana-3-1-flash`, and continue through T8 `/v1/images/generations`.
